...
¡P extract largest digit and multiply by 11 then

¡P extract smallest digit multiply by 7 then

¡P add both the result for getting bit pairs.
...
¡P Both bit scores should be in either odd position or even position to be eligible to form a pair.

¡P Pairs can be only made if most significant digit are same and at most two pair can be made for a given significant digit.
